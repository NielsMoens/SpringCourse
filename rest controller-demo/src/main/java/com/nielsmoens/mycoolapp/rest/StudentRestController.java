...
import com.nielsmoens.mycoolapp.entity.Student;
...
public class StudentRestController {
    ...
    public void loadData() {
        ...
        theStudents.add(new Student("Fons", "Makker"));
        theStudents.add(new Student("Alfonso", "Yow"));
        theStudents.add(new Student("Mario", "Bros"));
        theStudents.add(new Student("Jhon", "Tho"));
    }
